...
output "zookeeper_infra_volume_ids" {
  value = "${module.zookeeper-infra.volume_ids}"
}
...
output "es_data_v8_volume_ids" {
  value = "${module.es-data-v8.volume_ids}"
}

output "es_master_v8_volume_ids" {
  value = "${module.es-master-v8.volume_ids}"
}
